...
const translations = {
  lt: {
    ...
    menu: "Meniu",
    close: "Užverti",
    eyebrow: "Kūrybos studija · Vilnius · Bergen",
    heroFirst: "Gyva",
    heroSecond: "materija",
    heroNote:
  ...
  en: {
    ...
    menu: "Menu",
    close: "Close",
    eyebrow: "Creative studio · Vilnius · Bergen",
    heroFirst: "Living",
    heroSecond: "matter",
    heroNote:
    ...
    works: {
      evening: "Margarita at the evening",
      hands: "The Master`s hands",
      laurel: "Laurel signs",
      materials: "Material dialogue",
      nefertiti: "Nefertiti",
    },
    studioIndex: "Open studio",
    studioTitle: "Come in.",
    studioText:
  ...
  no: {
    ...
    menu: "Meny",
    close: "Lukk",
    eyebrow: "Kreativt studio · Vilnius · Bergen",
    heroFirst: "Levende",
    ...
    works: {
      evening: "Margarita om kvelden",
      hands: "Mesterens hender",
      laurel: "Laurbærtegn",
      materials: "Materialdialog",
      nefertiti: "Nefertiti",
    },
    studioIndex: "Åpent studio",
    studioTitle: "Kom inn.",
    studioText:
