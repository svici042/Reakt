...
const translations = {
  lt: {
    ...
    menu: "Meniu",
    close: "Užverti",
    eyebrow: "Kūrybos studija · Vilnius",
    heroFirst: "Gyva",
    heroSecond: "materija",
    heroNote:
    ...
    write: "Parašyti",
    location: "Vilnius · Lietuva / Bergenas · Norvegija",
  },
  en: {
    language: "Language",
    ...
    menu: "Menu",
    close: "Close",
    eyebrow: "Creative studio · Vilnius",
    heroFirst: "Living",
    heroSecond: "matter",
    heroNote:
    ...
    write: "Write to us",
    location: "Vilnius · Lithuania / Bergen · Norway",
  },
  no: {
    language: "Språk",
    ...
    menu: "Meny",
    close: "Lukk",
    eyebrow: "Kreativt studio · Vilnius",
    heroFirst: "Levende",
    heroSecond: "materiale",
    heroNote:
      "Form oppstår der hendene møter materialet. Vi skaper langsomt, modig og for å vare.",
    scroll: "Rull",
    ...
    manifestoText:
      "MATERIJA er et uavhengig kreativt studio der leire, tekstil og pigment blir til samtidige fortellinger. Hvert verk er laget for hånd og bevarer skaperens uperfekte, levende spor.",
    worksIndex: "02 / Utvalgte arbeider",
    collection: "Samling",
    filterLabel: "Filtrer arbeider",
    openWork: "Åpne kunstverk",
    filters: {
      all: "Alle",
      painting: "Maleri",
      ceramics: "Keramikk",
    ...
    studioIndex: "03 / Åpent studio",
    studioTitle: "Kom inn.",
    studioText:
      "Én gang i måneden åpner vi studiodørene. Bli kjent med materialene, se den kreative prosessen eller bli med på en liten praktisk økt.",
    blogIndex: "04 / Studiojournal",
    blogTitle: "På nært hold.",
    blogLead:
      "Prosessen, menneskene og materialene som former studioet vårt hver dag.",
    blogPosts: ["Leirens minne", "Stillheten i et portrett", "Tegn i naturen"],
    blogRead: "Les historien",
    places: "plasser",
    session: "økt",
    monthly: "per måned",
    question: "Har du en idé?",
    contact: "La oss gi den form.",
    write: "Skriv til oss",
    location: "Vilnius · Litauen / Bergen · Norge",
  },
};
    ...
    const update = () => {
      ...
      if (studioRef.current)
        root.style.setProperty(
          "--studio-top",
          studioRef.current.offsetTop.toFixed(1),
        );
      if (blogRef.current)
        root.style.setProperty(
          "--blog-top",
          blogRef.current.offsetTop.toFixed(1),
        );
...
function LanguagePicker({ language, setLanguage, t }) {
  ...
  useEffect(() => {
    const close = (event) =>
      !pickerRef.current?.contains(event.target) && setOpen(false);
  ...
  return (
    <>
      <header className="site-header">
        <a className="brand" href="#pradzia" onClick={close}>
          MATERIJA®
        </a>
  ...
  return (
    <section className="collection" id="darbai">
      <div className="collection-head">
        <div>
          <span className="section-index">{t.worksIndex}</span>
          <h2>{t.collection}</h2>
        </div>
            ...
            <figure className="art-card" key={work.id}>
              ...
              >
                <img
                  ...
                  srcSet={
                    work.small
                      ? `${work.small} 720w, ${work.image} 1400w`
                      : undefined
                  }
                ...
                <span className="art-meta">
                  <span>
                    {String(work.id).padStart(2, "0")} — {title}
                  </span>
                  <span>{t.filters[work.category]}</span>
                </span>
              </button>
            </figure>
          );
      ...
      {selected && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label={t.works[selected.key]}
          onMouseDown={(event) =>
        ...
        >
          ...
          <figure className="modal-figure">
            <img src={selected.image} alt={t.works[selected.key]} />
            <figcaption>
              <span>{t.works[selected.key]}</span>
              <span>{t.filters[selected.category]} / 2026</span>
            </figcaption>
          </figure>
        </div>
      )}
...
function StudioBlog({ t, language, blogRef }) {
  ...
  useEffect(() => {
    ...
    const getVisibleLabelIndex = (clientX, clientY) =>
      storyLinkRefs.current.findIndex((label) => {
    ...
    <section className="studio-blog" id="studio-blog" ref={blogRef}>
      <div className="blog-stage">
        ...
        <div className="blog-cards">
          {posts.map((post, index) => (
            <article
              className={`blog-card blog-card-${index + 1}`}
              key={post.date}
            >
              ...
              >
                <span
                  ref={(element) => {
                    storyLinkRefs.current[index] = element;
                  }}
                >
                  {t.blogRead} ↗
                </span>
      ...
      {selectedStory !== null && (
        <div
          ...
          onMouseDown={(event) =>
            event.target === event.currentTarget && setSelectedStory(null)
          }
        >
          <button
          ...
          <article className="story-dialog">
            ...
            <div className="story-copy">
              <span className="section-index">{t.blogIndex}</span>
              <h2 id="story-title">
                {blogEssays[language][selectedStory].title}
              </h2>
              {blogEssays[language][selectedStory].paragraphs.map(
                (paragraph, index) => (
    ...
    <div className="app">
      ...
      <main>
        <section className="hero" id="pradzia">
          ...
          <div className="hero-layer hero-portrait" aria-hidden="true">
            <img src="/images/hero-girl-1536.webp" alt="" />
          </div>
        ...
        <section className="studio" id="studija" ref={studioRef}>
          ...
          <div className="studio-depth-image" aria-hidden="true">
            <img src="/images/master-hands-720.webp" alt="" />
          </div>
        ...
        <section className="contact" id="kontaktai">
          <div className="contact-top">
            ...
            <a className="round-link" href="mailto:labas@materija.lt">
              {t.write} ↗
            </a>
          </div>
          <footer className="footer-line">
            <span>© 2026 MATERIJA kūrybos studija by LovLaus Media</span>
